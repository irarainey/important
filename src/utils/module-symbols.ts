/**
 * Known exported symbols for common Python stdlib modules (Python 3.11–3.12).
 * 
...
const MODULE_SYMBOLS: Readonly<Record<string, readonly string[]>> = {
    'os.path': [
        ...
        'isabs', 'isdir', 'isfile', 'isjunction', 'islink', 'ismount', 'join',
        'lexists', 'normcase', 'normpath', 'pardir', 'pathsep', 'realpath',
        'relpath', 'samefile', 'sameopenfile', 'samestat', 'sep', 'split',
        'splitdrive', 'splitext', 'splitroot', 'supports_unicode_filenames',
    ],
    'pathlib': [
    ...
    'typing': [
        ...
        'Collection', 'Concatenate', 'Container', 'ContextManager', 'Coroutine',
        'Counter', 'DefaultDict', 'Deque', 'Dict', 'Final', 'ForwardRef',
        'FrozenSet', 'Generator', 'Generic', 'Hashable', 'IO', 'ItemsView',
        'Iterable', 'Iterator', 'KeysView', 'List', 'Literal', 'LiteralString',
        'Mapping', 'MappingView', 'Match', 'MutableMapping', 'MutableSequence',
        'MutableSet', 'NamedTuple', 'Never', 'NewType', 'NoReturn', 'NotRequired',
        'Optional', 'OrderedDict', 'ParamSpec', 'ParamSpecArgs', 'ParamSpecKwargs',
        'Pattern', 'Protocol', 'Required', 'Reversible', 'Self', 'Sequence',
        ...
        'TypeAliasType', 'TypeGuard', 'TypeVar', 'TypeVarTuple', 'TypedDict',
        'Union', 'Unpack', 'ValuesView',
        'assert_never', 'assert_type', 'cast', 'clear_overloads',
        'dataclass_transform', 'final', 'get_args', 'get_origin', 'get_overloads',
    ...
    'sys': [
        ...
        'base_exec_prefix', 'base_prefix', 'breakpointhook',
        'builtin_module_names', 'byteorder', 'call_tracing', 'copyright',
        'displayhook', 'dont_write_bytecode', 'exc_info', 'excepthook',
        'exception', 'exec_prefix', 'executable', 'exit', 'flags', 'float_info',
        ...
        'stdout', 'stdlib_module_names', 'thread_info', 'unraisablehook',
